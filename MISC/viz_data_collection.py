...
def addPadding2FitRatio(img, ratio = (4,3)):
    ...
    new_w = int(m * ratio[1])
    pad = (new_w - w) // 2
    img2 = cv2.copyMakeBorder(img, 0, 0, pad, pad, cv2.BORDER_CONSTANT, value=[0,0,0])
    return img2
...
def read_data(folder_pth, folder_list):
    ...
    for folder in folder_list:
        ...
        elif folder == 'ml_depth_color' or folder == 'ml_intensity_color':
...
def main():
    ...
    folder_pth = '/media/ailab/HDD1/Workspace/dset/Drone-Detection-Custom/241108-indoor-gist/source_data/drone_2024-11-05-16-10-41_0'
    ...
    save_pth = '/media/ailab/HDD1/Workspace/src/Project/Drone24/detection/drone-mmdetection-jm/MISC/data_collection4.mp4'
    ...
    for i in range(len_img):
        ...
        img = np.concatenate((aligned_rgb, ir , ml_ambient), axis=1)
