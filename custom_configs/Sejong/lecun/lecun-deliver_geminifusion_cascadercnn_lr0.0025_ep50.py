...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='DELIVER',
            name='lecun-deliver_geminifusion_cascadercnn_lr0.0025_ep50',
            tags=['Geminifusion', 'CascadeRCNN', 'full-finetune', 'epoch-50'],
            notes='Geminifusion CascadeRCNN with epoch 50',
            save_code=True
        ),
    )
]
...
experiment_name = 'lecun-deliver_geminifusion_cascadercnn_lr0.0025_ep50'
