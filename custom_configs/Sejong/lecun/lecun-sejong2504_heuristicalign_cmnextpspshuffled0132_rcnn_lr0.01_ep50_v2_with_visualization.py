...
data_root = '/ailab_mat2/dataset/drone/250312_sejong/drone_250312_sejong_V2/'
...
train_pipeline = [
    ...
    dict(
        type='DELIVERResize',
        img_scale=[(400, 381),  (440, 419)], # 4:3 비율 유지
        keep_ratio=True,
        bbox_format='xywh'
    ),
    dict(
...
model = dict(
    ...
    backbone=dict(
        ...
        backbone='CMNeXtPSPShuffled0213-B2',
...
experiment_name = 'sejong2504_heuristicalign_cmnextpspshuffled_b2_rcnn_multiscale_v2_with_visualization'
