...
#/SSDb/jemo_maeng/src/Project/Drone24/detection/drone-mmdetection-jm/custom_configs/Project_Drone/Paper/datav2/llvip/debug_hinton_ATTNet_swin_fpn_2x_datav2_llvip_rgbt_lr001.py
import os
_base_ = [
