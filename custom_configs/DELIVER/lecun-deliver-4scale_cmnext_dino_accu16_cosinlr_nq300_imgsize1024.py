# custom_configs/DELIVER/hinton-deliver-4scale_cmnext_dino_accu16_cosinlr_adamw_nq300.py
...
train_pipeline = [
    ...
    dict(
        ...
        scales=[(1024, 1024), (900, 1024), (1024, 900)],
        keep_ratio=True,
        bbox_format='xywh'
    ),
...
experiment_name = 'lecun-deliver-4scale_cmnext_dino_accu16_cosinlr_nq300_imgsize1024'
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='DELIVER',
            name='lecun-deliver-4scale_cmnext_dino_accu16_cosinlr_nq300_imgsize1024',
            tags=['CMNeXt', 'DINO', 'full-finetune', f'epoch-{max_epochs}'],
            notes=f'CMNeXt DINO with epoch {max_epochs} cosinelr',
            save_code=True
        ),
    )
]
