...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='DELIVER',
            name='lecun-deliver_stitchfusion_retinanet_lr0.01_ep50',
            tags=['Stitfusion', 'RetinaNet', 'full-finetune', 'epoch-50'],
            notes='Stitfusion RetinaNet with epoch 50 SGD',
            save_code=True
        ),
    )
]
...
experiment_name = 'lecun-deliver_stitchfusion_rcnn_lr0.01_sharedeverytwo'
