...
#     def __init__(self, inplanes, planes, stride=1, downsample=None, attention=None, reduction=16, pool_types=['avg', 'max'], no_spatial=False):
#         super(BasicBlockWithAttention, self).__init__(inplanes, planes, stride, downsample)
#         # self.attention_type = attention_type
#         self.attention = attention(planes)
#         print(self.attention)

#         # self.attention = att_type
#         # if attention_type == 'se':
#         #     self.attention = SEBlock(planes, reduction)
#         # elif attention_type == 'spatial':
#         #     self.attention = SpatialAttBlock(planes)
#         # elif attention_type == 'cbam':
#         #     self.attention = CBAMBlock(planes, reduction, pool_types, no_spatial)
#         # else:
#         #     self.attention = None
...
#                  pretrained=None,
#                  init_cfg=None):
#         super(ResNet, self).__init__(init_cfg=None)
...
#         layers = []
#         layers.append(BasicBlockWithAttention(inplanes, planes, stride, dilation, downsample, self.attention))
#         inplanes = planes * block.expansion
#         for _ in range(1, blocks):
#             layers.append(BasicBlockWithAttention(inplanes, planes, attention=self.attention))
