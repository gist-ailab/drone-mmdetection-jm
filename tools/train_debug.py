...
def parse_args():
    ...
    parser.add_argument('--config',default='/media/ailab/HDD1/Workspace/src/Project/Drone24/detection/drone-mmdetection-jm/custom_configs/DELIVER/lecun-sejong2504_cmnext_rcnn_lr0.01_ep50_v2.py', help='train config file path')
